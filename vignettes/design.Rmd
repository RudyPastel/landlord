...
This vignette documents my choices and my rationales.
...
![Investment concept map](.\images\investmentConceptMap.png){width=100%}
...
called `{golem}` which promises production grade Shiny dashboard. Given the 
customer's interest in production grade R development and the scarcity of skilled
developer, this seems a valuable skill. Confronting my practice to their principles
